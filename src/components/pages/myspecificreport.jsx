...
import { fetchReportsByPatientId, fetchReportsByPatientAndDoctor } from "../slices/slice/reportSlice";
...
export default function MySpecificReports({ user }) {
	...
	useEffect(() => {
		...
		if (doctorId) {
			dispatch(fetchReportsByPatientAndDoctor({ patientId: userId, doctorId }));
		} else {
